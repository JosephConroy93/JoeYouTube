...
- **validate-scenes style check: a faint nose curve is a note, not a regenerate** (fully drawn faces and tan skin still fail; references stay strict). Why: operator call on Embalmer Level 3; hardening rule V9.
